...
stack:				;stack goes in ABC and if you pop value it goes CBA
...
msec:                           ;this isn't where we start - it's a subroutine
    ...
    push    w1                  ;save WREG1
    mov     #5331,w1		; assign 5331 to w1
				;how did we come up with this magic number? 
msloop:
    sub     #1,w1		; subtract/decrement w1
    bra     NZ,msloop		; branch to msloop if the result of the last. NZ means nonzero
